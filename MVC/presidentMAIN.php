...
if(mysqli_num_rows($result)==0){
    ...
    echo "<tr><td>申請人</td><td>父</td><td>母</td><td>老師建議</td><td>秘書建議</td><td>金額</td><td>申請補助種類</td><td>審核</td></tr>";
    while ($rs=mysqli_fetch_assoc($result)) {
        ...
        echo "<td><button><a href='presidentUpdate.php?id={$rs['stuID']}'>通過</a></button><button><a href='presidentUpdate.php?id={$rs['stuID']}'>未通過</a></button></td>";
        echo "</tr>";
    }
}
?>
